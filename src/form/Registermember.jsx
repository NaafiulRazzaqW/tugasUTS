...
export default function Register() {
    ...
    {
        e.preventDefault();
        if(!noHandphone && !noRumah && !noKantor) return Swal.fire({
            icon: 'error',
            title: 'Oops...',
        ...
        Swal.fire({
            icon: 'success',
            title: 'Success',
            html: `<p>Nama Anda: ${nama}</p>` +
            `<p>Nomer Pekerja Anda: ${noPekerja}</p>` +
            (!noHandphone == false ? `<p>Nomer Handphone Anda: ${noHandphone}</p>` : '') +
        ...
        <div className="p-10 flex justify-center text-start font-sans font-semibold">
          <form onSubmit={handleSubmit} className="">
            <div className="grid grid-cols-2 gap-3">
                <h1 className="col-span-2 text-[30px] font-bold">Formulir Pengerjaan</h1>
                <h3 className="col-span-2 text-gray-400 font-semibold">Isikan data dibawah dengan benar!</h3>
              <div>
